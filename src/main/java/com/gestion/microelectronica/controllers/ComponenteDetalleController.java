...
public class ComponenteDetalleController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se ha Insertado el Detalle del Componente Correctamente", content = {
					@Content(mediaType = "application/json") }),
			@ApiResponse(responseCode = "400", description = "No se pudo Insertar el Detalle del Componente. Comprobar la Solicitud", content = @Content),
			@ApiResponse(responseCode = "404", description = "La Inserción del Detalle del Componente no está Disponible ya que el recurso pedido no existe. Comprobar solicitud", content = @Content),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se ha Actualizado el Detalle del Componente Correctamente", content = {
					@Content(mediaType = "application/json") }),
			@ApiResponse(responseCode = "400", description = "No se pudo Actualizar el Detalle del Componente. Comprobar la Solicitud", content = @Content),
			@ApiResponse(responseCode = "404", description = "La Actualización del Detalle del Componente no está Disponible ya que el recurso pedido no existe. Comprobar solicitud", content = @Content),
			@ApiResponse(responseCode = "500", description = "Se ha producido un error interno en el Servidor", content = @Content) })
	@PutMapping("/")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se ha Eliminado el Detalle del Componente Correctamente", content = {
					@Content(mediaType = "application/json") }),
			@ApiResponse(responseCode = "400", description = "No se pudo Eliminar el Detalle del Componente. Comprobar la Solicitud", content = @Content),
			@ApiResponse(responseCode = "404", description = "La Eliminación del Detalle del Componente no está Disponible ya que el recurso pedido no existe. Comprobar solicitud", content = @Content),
			@ApiResponse(responseCode = "500", description = "Se ha producido un error interno en el Servidor", content = @Content) })
	@DeleteMapping("/{id}")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Se ha Traído el Listado de los Detalles de los Componentes Correctamente", content = {
					@Content(mediaType = "application/json") }),
			@ApiResponse(responseCode = "400", description = "No se pudo traer el Listado de los Detalles de los Componentes. Comprobar la Solicitud", content = @Content),
			@ApiResponse(responseCode = "404", description = "El Listado de los Detalles de los Componentes no está Disponible ya que el recurso pedido no existe. Comprobar solicitud", content = @Content),
			@ApiResponse(responseCode = "500", description = "Se ha producido un error interno en el Servidor", content = @Content) })
	@GetMapping("/listado")
	...
	public Page<ComponenteDetalleEntity> getByHojaDeDatos(@PathVariable("hojaDatos") String hojaDatos,
			Pageable pageable) {
	...
	public Page<ComponenteDetalleEntity> getByVoltajeRecomendado(
			@PathVariable("voltajeRecomendado") String voltajeRecomendado, Pageable pageable) {
	...
	public Page<ComponenteDetalleEntity> getByVoltajeMinEntrada(
			@PathVariable("voltajeMinEntrada") String voltajeMinEntrada, Pageable pageable) {
	...
	public Page<ComponenteDetalleEntity> getByVoltajeMaxEntrada(
			@PathVariable("voltajeMaxEntrada") String voltajeMaxEntrada, Pageable pageable) {
	...
	public ModelAndView estadoServicioModelAndView() {
		...
		mav.setViewName("componentes-detalles/comp-det-estado-servicio");
