...
public class ComponenteService {
	...
	// ===============
	// ------ STOCK POR CATEGORIA ------
	public int stockPorCategoria(Page<ComponenteEntity> listComp, String categoria) {
	...
	public int stockPorFabricante(Page<ComponenteEntity> listComp, String fabricante) {
